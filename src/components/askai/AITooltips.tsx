const AITooltips = () => {
  return (
    <div className='absolute top-5 right-5 flex justify-end group'>
      <button className='border-2 border-defaultRadicalred text-defaultRadicalred w-8 h-8 rounded-full font-bold'>
        !
      </button>
      <div className='absolute top-10 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50 pointer-events-none w-72 md:w-[420px]'>
